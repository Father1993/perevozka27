        ...
        <div className='px-6 py-8'>
          ...
          <div className='space-y-6 text-gray-700'>
            <p>
              ...
              обработку моих персональных данных ООО "Перевозка27" (ИНН
              XXXXXXXXXX, ОГРН XXXXXXXXXXXX, адрес: XXXXXXXXXX) (далее —
            ...
            <p>
              1.1. Оператор - ООО "Перевозка27", осуществляющее обработку
